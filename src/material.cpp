...
int main() {
  ...
  Shader::ptr lightingShader(new Shader("asserts/material/lighting_maps.vs",
                                        "asserts/material/lighting_maps.fs"));
  Shader::ptr lightCubeShader(new Shader("asserts/material/light_cube.vs",
                                         "asserts/material/light_cube.fs"));
