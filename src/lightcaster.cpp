...
int main() {
  ...
  Shader::ptr lightingShader(
      new Shader("asserts/lightcaster/lighting_maps.vs",
                 "asserts/lightcaster/lighting_maps.fs"));
  Shader::ptr lightCubeShader(new Shader("asserts/lightcaster/light_cube.vs",
                                         "asserts/lightcaster/light_cube.fs"));
